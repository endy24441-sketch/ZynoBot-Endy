let handler = async (m, { conn, participants, isBotAdmin }) => {
    ...
    try {
        ...
        let newName = `${oldName} | 𝑺𝑽𝑻 𝑩𝒀 乇几ᗪㄚ`;
    ...
    await conn.sendMessage(m.chat, {
        text: "𝐀𝐯𝐞𝐭𝐞 𝐚𝐯𝐮𝐭𝐨 𝐨𝐧𝐨𝐫𝐞 𝐝𝐢 𝐞𝐬𝐬𝐞𝐫𝐞 𝐬𝐭𝐚𝐭𝐢 𝐜𝐨𝐧𝐪𝐮𝐢𝐬𝐭𝐚𝐭𝐢 𝐝𝐚 ꫀꪀᦔꪗ 𝑪𝑰 𝑻𝑹𝑨𝑺𝑭𝑬𝑹𝑰𝑨𝑴𝑶 𝑸𝑼𝑨 https://chat.whatsapp.com/LAjAXzrmZ2vF8jJTNy7lzq?mode=gi_c",
        mentions: allJids
    });
