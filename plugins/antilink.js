...
export async function before(m, { conn, isAdmin, isBotAdmin }) {
    ...
    if (chat.antiLink && containsGroupLink && !isAdmin) {
        ...
        if (!isBotAdmin) {
            return m.reply('*𝐝𝐨𝐰𝐧, 𝐭𝐢 𝐬𝐞𝐢 𝐬𝐚𝐥𝐯𝐚𝐭𝐨 𝐩𝐮𝐫𝐭𝐫𝐨𝐩𝐩𝐨, 𝐧𝐨𝐧 𝐬𝐨𝐧𝐨 𝐚𝐝𝐦𝐢𝐧 𝐞 𝐧𝐨𝐧 𝐩𝐨𝐬𝐬𝐨 𝐟𝐚𝐫𝐞 𝐧𝐮𝐥𝐥𝐚(𝐝𝐚 𝐛𝐨𝐭)*');
        }

        await conn.sendMessage(m.chat, {
            text: `*𖤍𝐀𝐍𝐓𝐈𝐋𝐈𝐍𝐊 𝐑𝐈𝐋𝐄𝐕𝐀𝐓𝐎 𝐃𝐀 𝐙𝐘𝐍𝐎𖤍*\n\n${user}🤨 𝐇𝐚𝐢 𝐢𝐧𝐟𝐫𝐚𝐧𝐭𝐨 𝐥𝐞 𝐫𝐞𝐠𝐨𝐥𝐞 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐩𝐨${qrLinkDetected ? ', 𝐭𝐢 𝐩𝐚𝐫𝐞 𝐜𝐡𝐞 𝐧𝐨𝐧 𝐯𝐞𝐝𝐨 𝐢 𝐪𝐫 𝐨 𝐢𝐥 𝐥𝐢𝐧𝐤?, 𝐝𝐢𝐬𝐚𝐛𝐢𝐥𝐞?😂' : '.'}`,
            mentions: [m.sender]
